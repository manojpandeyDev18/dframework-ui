...
import yt, { createContext as Ut, useContext as pr, useState as A, useEffect as oe, useReducer as aa, useMemo as ge, useCallback as Ot, memo as Vr, useRef as Sr, createElement as fr } from "react";
...
const en = Ut(null), So = "bottom", Ao = "center", Oo = yt.forwardRef(function(t, r) {
  ...
  const [t, r] = A(null), [a, o] = A(!1), [s, i] = A(null), [d, m] = A(null), g = function(l, h, c = "info", f) {
  ...
  return pr(en);
}, je = ({ open: e, onConfirm: t, title: r = "Confirm", onCancel: a, okText: o, cancelText: s, yesNo: i = !1, children: d, maxWidth: m = "sm", fullWidth: g = !0, ...u }) => (o = o || (i ? "Yes" : "Ok"), s = s || (i ? "No" : "Cancel"), /* @__PURE__ */ C(
  sa,
  {
    ...u,
    open: e,
...
const We = {
  ...
  try {
    ...
    wt--;
    const u = g.data;
    if (wt === 0 && !i && d({ type: "UPDATE_LOADER_STATE", loaderOpen: !1 }), g.status === We.SESSION_EXPIRED) {
      r("/login");
      return;
    }
    return g.status !== We.OK ? { data: { message: u.message || "An error occurred" } } : u;
  } catch (g) {
...
}, Io = ["date", "dateTime"], Fo = ["singleSelect"], Mr = 200, Mo = (e) => (/* @__PURE__ */ new Date()).getTimezoneOffset() === new Date(e).getTimezoneOffset(), et = (e, t) => e.status === We.SESSION_EXPIRED ? (t("Session Expired!"), setTimeout(() => {
  window.location.href = "/";
}, Mr), !0) : e.status === We.FORBIDDEN ? (t("Access Denied!"), setTimeout(() => {
  window.location.href = "/";
}, Mr), !0) : (e.status === We.INTERNAL_SERVER_ERROR && t("Internal Server Error"), !1);
function Ro(e) {
  const { operator: t, value: r, type: a } = e, o = ["isEmpty", "isNotEmpty"].includes(t), s = r != null && (r !== "" || a === "number" && r === 0 || a === "boolean" && r === !1);
  return o || s;
}
const No = async ({ gridColumns: e, setIsLoading: t, setData: r, page: a, pageSize: o, sortModel: s, filterModel: i, api: d, parentFilters: m, action: g = "list", setError: u, extraParams: p, contentType: l, columns: h, controllerType: c = "node", template: f = null, configFileName: b = null, dispatchData: E, showFullScreenLoader: x = !1, model: T, baseFilters: O = null, isElasticExport: N }) => {
  l || x && E({ type: V.UPDATE_LOADER_STATE, payload: !0 });
  const K = [], q = [], ae = [];
  e.forEach(({ lookup: M, type: H, field: U, keepLocal: P = !1, keepLocalDate: W, filterable: Y = !0, dependsOn: J }) => {
    Io.includes(H) && ae.push({ field: U, keepLocal: P, keepLocalDate: W }), M && !K.includes(M) && Fo.includes(H) && Y && (K.push(M), q.push({ lookup: M, dependsOn: J }));
  });
  const ee = [];
  i?.items?.length && i.items.forEach((M) => {
    if (Ro(M)) {
      const { field: H, operator: U, filterField: P } = M;
      let { value: W } = M;
  ...
  if (f !== null && (te += `&template=${f}`), b !== null && (te += `&configFileName=${b}`), l) {
    ...
    if (F.responseType = l, F.columns = h, F.userTimezoneOffset = -(/* @__PURE__ */ new Date()).getTimezoneOffset(), M.setAttribute("method", "POST"), M.setAttribute("id", "exportForm"), M.setAttribute("target", "_blank"), f === null)
      for (const H in F) {
        ...
        P.type = "hidden", P.name = H, P.value = U, M.append(P);
      }
    ...
    if (H.status === We.OK) {
      ...
      U && U.forEach((P) => {
        ae.forEach((W) => {
          ...
          if (P[Y]) {
            if (P[Y] = new Date(P[Y]), ye) {
              const Z = P[Y].getTimezoneOffset() * 6e4;
              P[Y] = new Date(P[Y].getTime() + Z);
            }
            if (J && !Mo(P[Y])) {
              const Z = P[Y].getTimezoneOffset() * 6e4;
              P[Y] = new Date(P[Y].getTime() + Z);
  ...
  const a = t.current.state.pagination.paginationModel.page, o = t.current.state.pagination.paginationModel.pageSize, s = t.current.state.rows.totalRowCount, i = Math.ceil(s / o), { t: d, i18n: m } = mr(), g = { t: d, i18n: m }, [u, p] = A(a + 1), l = function(f) {
...
}, Ml = ln.Provider, Kt = () => pr(ln), He = () => {
  const e = pr(sn);
  if (e === void 0)
    throw new Error("useStateContext must be used within a StateProvider");
  return e;
}, oi = () => {
  const [e, t] = A(), [r, a] = A(!1), { stateData: o, dispatchData: s } = He(), i = o.modal, d = 16 / 9;
  ...
  return oe(() => {
    ...
    c && /* @__PURE__ */ C(ue, { children: [
      /* @__PURE__ */ n(Hr, { sx: { mb: 3 }, children: /* @__PURE__ */ C(Kr, { sx: { backgroundColor: u || "#fff" }, children: [
        ...
        /* @__PURE__ */ n(Ue, { className: "app-page-title--first", children: /* @__PURE__ */ n("div", { children: /* @__PURE__ */ n("div", { style: { display: l ? "block" : "flex", alignItems: "center" }, children: /* @__PURE__ */ n("div", { style: { flex: "1 0 auto" }, children: /* @__PURE__ */ n(
          Rr,
          {
...
const si = {
  ...
  const { fixedFilterFormat: t } = ct, { item: r, applyValue: a, convert: o } = e, { systemDateTimeFormat: s, stateData: i } = He(), d = e?.type || "date", m = t[d], g = (f) => {
    const b = re(f);
  ...
  { field: "editAction", type: "actions", headerName: "", width: 20, getActions: () => [/* @__PURE__ */ n(ze, { icon: /* @__PURE__ */ C(Pe, { title: Ie.Edit, children: [
    "   ",
    /* @__PURE__ */ n(cr, {})
  ] }), tabIndex: 1, "data-action": Ie.Edit, label: "Edit", color: "primary" }, 1)] },
  { field: "deleteAction", type: "actions", headerName: "", width: 20, getActions: () => [/* @__PURE__ */ n(ze, { icon: /* @__PURE__ */ C(Pe, { title: Ie.Delete, children: [
    /* @__PURE__ */ n(Wr, {}),
    " "
  ...
  const { stateData: s, dispatchData: i, removeCurrentPreferenceName: d, getAllSavedPreferences: m } = He(), { navigate: g } = Kt(), u = Ur(), p = Ht(), { t: l, i18n: h } = mr(), c = { t: l, i18n: h }, [f, b] = A(!1), [E, x] = A(!1), [T, O] = A([]), [N, K] = A(), [q, ae] = A(), [ee, F] = A(!1), [X, te] = A({}), { Username: M } = s?.getUserData ? s.getUserData : {}, H = s?.preferences, U = s?.currentPreference, P = s?.gridSettings?.permissions?.preferenceApi, W = s?.gridSettings?.permissions?.defaultPreferenceEnums, Y = lr(r, Gr), J = lr(r, ma), ye = ge(() => ne.object({
  ...
  const Z = Jr({
    ...
    const le = await At({ url: P, params: {
      action: "delete",
      id: t,
      Username: M,
      prefIdArray: S
    ...
    const k = S.prefName.trim(), Ce = H.findIndex((Ae) => Ae.prefName === k);
    if (Ce > -1 && (N === it.Add || H[Ce].prefId !== S.prefId)) {
      F(!0);
      return;
    }
    const { pinnedColumns: le } = r.current.state, { orderedFields: ce, columnVisibilityModel: Ke, lookup: Se } = r.current.state.columns, qe = [];
    ce?.forEach((Ae) => {
      const { field: Ye } = Se[Ae], ke = a.find((at) => at.field === Ye) || Se[Ae];
      ke.width = Se[Ae].width, qe.push(ke);
    });
    const he = Y?.items?.map((Ae) => {
      const { field: Ye, operator: ke, value: at } = Ae;
      return { field: Ye, operator: ke, value: at };
    });
    Y.items = he;
    const ie = {
      action: "save",
      ...
      prefName: k,
      prefDesc: S.prefDesc,
      prefValue: { sortModel: J, filterModel: Y, columnVisibilityModel: Ke, gridColumn: qe, pinnedColumns: le },
      isDefault: S.isDefault
    };
    S.prefId && (ie.prefId = S.prefId);
    const Me = await At({ url: P, params: ie, history: g, dispatchData: i }), fe = N === it.Add ? "Added" : "Saved";
    (Me === !0 || Me?.success === !0) && (p.showMessage(`Preference ${fe} Successfully.`), rt()), m({ preferenceName: t, Username: M, history: g, dispatchData: i, preferenceApi: P, defaultPreferenceEnums: W });
  }, Le = async (S) => {
    let k, Ce = "Default";
    if (S === 0)
      k = W[t] || null;
    else {
      const ie = await At({ url: P, params: {
        action: "load",
        id: t,
        Username: M,
        prefId: S
    ...
    if (!k) return;
    const { gridColumn: le, columnVisibilityModel: ce, pinnedColumns: Ke, sortModel: Se, filterModel: qe } = k;
    le.forEach(({ field: he, width: ie }) => {
      r.current.getColumnIndex(he) !== -1 && r.current.setColumnWidth(he, ie);
    }), r.current.setColumnVisibilityModel(ce), r.current.state.columns.orderedFields = le.map(({ field: he }) => he), r.current.setPinnedColumns(Ke), r.current.setSortModel(Se || []), r.current.setFilterModel(qe), i({ type: V.SET_CURRENT_PREFERENCE_NAME, payload: Ce }), o(!0);
  }, we = (S) => S.GridPreferenceId, ut = (S, k = !0) => {
    K(S), Te(), b(!0), x(k), k && Z.resetForm();
  }, xt = async () => {
    const { prefId: S, preferenceName: k } = X;
    await Re(S, k), m({ preferenceName: t, history: g, dispatchData: i, Username: M, preferenceApi: P, defaultPreferenceEnums: W }), te({});
  }, pt = async (S) => {
    const k = S.field === "editAction" ? Ie.Edit : S.field === "deleteAction" ? Ie.Delete : null;
    if (S.id === 0 && (k === Ie.Edit || k === Ie.Delete)) {
      p.showMessage(`Default Preference Can Not Be ${k === Ie.Edit ? "Edited" : "Deleted"}`);
      return;
    }
    k === Ie.Edit && (K("Modify"), Z.setValues(S?.row), x(!0)), k === Ie.Delete && te({
      prefId: S.id,
    ...
    /* @__PURE__ */ C(
      Fa,
      {
        ...
        children: [
          ...
          H?.length > 0 && H?.map((S) => {
            const { prefName: k, prefDesc: Ce, prefId: le } = S;
            return /* @__PURE__ */ n(
              _t,
              {
                onClick: () => Ne(le),
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ C(Ti, { ...e, children: [
          ...
          T && /* @__PURE__ */ n(pi, { preferenceName: T, gridRef: O, columns: N, setIsGridPreferenceFetched: K })
        ] })
      ]
    }
  );
  ...
  const [W, Y] = A({ pageSize: bi, page: 0 }), [J, ye] = A({ recordCount: 0, records: [], lookups: {} }), [Z, be] = A(!0), Te = !!c, rt = E, [Re, Ne] = A([]), [Be, Le] = A(!1), [we, ut] = A(null), xt = { CreatedOn: !1, CreatedByUser: !1, ...e.columnVisibilityModel }, [pt, nt] = A(!1), pe = Ht(), S = e.paginationMode === $.client ? $.client : $.server, { t: k, i18n: Ce } = mr(), le = { t: k, i18n: Ce }, [ce, Ke] = A(""), [Se, qe] = A(hi(a || e.defaultSort, $, Ci)), he = { items: [], logicOperator: "and", quickFilterValues: Array(0), quickFilterLogicOperator: "and" };
  e.defaultFilters && (he.items = [], e.defaultFilters.forEach((y) => {
    he.items.push(y);
  }));
  const [ie, Me] = A({ ...he }), { navigate: fe, getParams: Ae, useParams: Ye, pathname: ke } = Kt(), { id: at } = Ye() || Ae, Pt = at?.split("-")[0], _e = Ur(), { idProperty: me = "id", showHeaderFilters: B = !0, disableRowSelectionOnClick: Ee = !0, hideBackButton: Q = !1, hideTopFilters: Je = !0, updatePageTitle: Ze = !0, isElasticScreen: Xe = !1, navigateBack: qt = !1, selectionApi: ft = {} } = e, $e = e.readOnly === !0 || H, It = e.allowDoubleClick === !1, Yt = Sr(J), mn = e.showAddIcon === !0, hn = e.columns.filter(({ link: y }) => !!y).map((y) => y.link), [yr, br] = A(!1), { stateData: Ve, dispatchData: Oe, formatDate: Jt, removeCurrentPreferenceName: gn, getAllSavedPreferences: yn, applyDefaultPreferenceIfExists: bn } = He(), { timeZone: Zt } = Ve, Dt = { ...$.permissions, ...Ve.gridSettings.permissions, ...e.permissions, ...g }, { Username: Cn } = Ve?.getUserData ? Ve.getUserData : {}, {
    gridSettings: {
      permissions: {
    ...
    const I = y.row[me], [w, D] = A(se.current.has(I));
    return oe(() => {
      D(se.current.has(I));
    ...
    date: {
      valueFormatter: (y) => Jt({ value: y, useSystemFormat: !0, showOnlyDate: !1, state: Ve.dateTime, timeZone: Zt }),
      filterOperators: Bt({ columnType: "date" })
    },
    dateTime: {
      valueFormatter: (y) => Jt({ value: y, useSystemFormat: !1, showOnlyDate: !1, state: Ve.dateTime, timeZone: Zt }),
  ...
  const { customActions: rr = [] } = e, { gridColumns: Qe, pinnedColumns: $n, lookupMap: nr } = ge(() => {
    ...
    const _ = [];
    return !Te && !$e && (Er && _.push(/* @__PURE__ */ n(ze, { icon: /* @__PURE__ */ n(Pe, { title: "Edit", children: /* @__PURE__ */ n(cr, {}) }), "data-action": xe.Edit, label: "Edit", color: "primary" })), Dt.copy && _.push(/* @__PURE__ */ n(ze, { icon: /* @__PURE__ */ C(Pe, { title: "Copy", children: [
      /* @__PURE__ */ n(Ar, {}),
      " "
    ] }), "data-action": xe.Copy, label: "Copy", color: "primary" })), On && _.push(/* @__PURE__ */ n(ze, { icon: /* @__PURE__ */ C(Pe, { title: "Delete", children: [
      /* @__PURE__ */ n(Wr, {}),
      " "
    ] }), "data-action": xe.Delete, label: "Delete", color: "error" })), Fn && _.push(/* @__PURE__ */ n(ze, { icon: /* @__PURE__ */ C(Pe, { title: "History", children: [
      /* @__PURE__ */ n(to, {}),
      " "
    ...
    })), Cr.length && _.push(/* @__PURE__ */ n(ze, { icon: /* @__PURE__ */ C(Pe, { title: "Download document", children: [
      /* @__PURE__ */ n(ro, {}),
      " "
    ...
    e.joinColumn && Pt && U.push({ field: e.joinColumn, operator: "is", type: "number", value: Number(Pt) }), F && (L.items = [...L.items || [], ...F]), I = { ...I, ...P.extraParams }, (!L.items.length || L.items.every((ot) => "value" in ot && ot.value !== void 0)) && No({
      action: y,
      page: w ? 0 : G,
      pageSize: w ? 1e6 : R,
      sortModel: Se,
    ...
    await an({ id: we.id, api: `${e.controllerType === "cs" ? Xt : vt}${e.api || r}`, setIsLoading: be, setError: pe.showError, setErrorMessage: Ke }) === !0 ? (Le(!1), pe.showMessage("Record Deleted Successfully."), Rt()) : Le(!1);
  }, vr = () => {
    Ke(null), Le(!1);
  }, Gn = (y) => (typeof P.processRowUpdate == "function" && P.processRowUpdate(y, J), y), jn = (y) => {
    if (y.row.canEdit === !1)
      return;
    const { row: I } = y;
    ...
    if (!$e && !It && !h && Nt({ id: I[me], record: I }), $e && e.rowRedirectLink) {
      const w = {
    ...
    bn({ preferenceName: y, dispatchData: Oe, gridRef: _e, setIsGridPreferenceFetched: br, defaultPreferenceEnums: D, preferences: v });
  };
  oe(() => {
  ...
  const Xn = (y) => y[me], Qn = (y) => {
    ...
    const { orderedFields: I, columnVisibilityModel: w, lookup: D } = _e.current.state.columns, v = y.target.dataset.isPivotExport === "true", _ = Object.keys(w).filter((z) => w[z] === !1), R = new Set(Qe.filter((z) => z.exportable === !1).map((z) => z.field)), G = I.filter(
  ...
  return /* @__PURE__ */ C(ue, { children: [
    ...
    /* @__PURE__ */ n(Hr, { style: ae || f, elevation: 0, sx: { "& .MuiCardContent-root": { p: 0 } }, children: /* @__PURE__ */ C(Kr, { children: [
      ...
      ce && /* @__PURE__ */ C(je, { open: !!ce, onConfirm: vr, onCancel: vr, title: "Info", hideCancelButton: !0, children: [
        " ",
        ce
      ] }),
      Be && !ce && /* @__PURE__ */ n(je, { open: Be, onConfirm: Un, onCancel: () => Le(!1), title: "Confirm Delete", children: /* @__PURE__ */ C(Nr, { children: [
...
const Ai = 47, Oi = 58, Pi = 37, Ii = 40, Fi = [8, 46, 9, 27, 13], Lr = ({ value: e, state: t }) => {
  ...
  const { min: s, max: i } = e, d = Ct(), [m, g] = A(r.values[a]), u = dn(m, 400), p = ge(
  ...
  const i = s !== "copy" && o.disabled, { systemDateTimeFormat: d, stateData: m } = He();
  return /* @__PURE__ */ fr(
    Yr,
    {
      ...a,
  ...
  const { systemDateTimeFormat: o, stateData: s } = He();
  return /* @__PURE__ */ fr(
    ur,
    {
      ...a,
...
function un({ column: e, formik: t, lookups: r, dependsOn: a = [], isAutoComplete: o = !1, userSelected: s, model: i }) {
  const [d, m] = A([]), { stateData: g } = He(), u = g?.gridSettings?.permissions?.Url || "", p = ge(() => `${u}${i?.api || ""}`, [u, i?.api]), l = ge(() => {
    const f = {};
...
const _i = yt.memo(({ column: e, field: t, formik: r, lookups: a, dependsOn: o = [], model: s, ...i }) => {
  ...
  limitTags: 5
}, Ui = Ge.memo(({ column: e, field: t, formik: r, lookups: a, dependsOn: o = [], fieldConfigs: s = {}, mode: i, model: d, ...m }) => {
  ...
  const { setFieldValue: o } = r, { value: s } = r.getFieldProps(e || t), i = "1000001", d = "0111110", m = "0".repeat(7), [g, u] = A(s || m), [p, l] = A(() => s ? s === i ? i : s === d ? d : "Custom" : ""), [h, c] = A(!1), f = Ot((x) => {
    if (Array.isArray(x)) {
      let T = m;
      for (const O of x)
        T = T.substring(0, O) + "1" + T.substring(O + 1);
      u(T), o(e || t, T), c(!0);
    } else {
      let T = h ? m : g;
      const O = T.slice(0, x) + (T[x] === "1" ? "0" : "1") + T.slice(x + 1);
      u(O), o(e || t, O), l("Custom"), c(!1);
    }
  ...
  const g = Ge.useMemo(() => i === "copy" ? !0 : typeof s.disabled < "u" ? s.disabled : typeof t.disabled == "function" ? t.disabled({ isAdd: e, formik: a }) : !!t.disabled, [i, s.disabled, t.disabled]), u = t.hasDefault && !e ? [m[0]] : [], p = Ot((l, h, c, f = {}) => {
    const b = h.pop()?.trim();
...
function es({ column: e, field: t, formik: r }) {
  const a = r.values[t] || "", { stateData: o } = He(), { maxSize: s, formats: i } = e, { uploadApi: d, mediaApi: m, Url: g } = o?.gridSettings?.permissions, [u, p] = A({
    isExternal: "no",
    selectedFile: null
  }), [l, h] = A(!1), c = Ht(), { getParams: f, useParams: b } = Kt(), { associationId: E } = b() || f, x = E?.split("-")[0] || 1, T = (F) => {
  ...
  return /* @__PURE__ */ C(Ue, { children: [
    /* @__PURE__ */ C(Ue, { sx: { display: "flex", alignItems: "center", marginBottom: 2 }, children: [
    ...
    /* @__PURE__ */ C(Ue, { sx: { display: "flex", alignItems: "center", marginBottom: 2 }, children: [
      ...
      /* @__PURE__ */ C(Ue, { sx: { flex: 1, display: "flex", flexDirection: "column" }, children: [
    ...
    u.isExternal === "no" && /* @__PURE__ */ C(Ue, { sx: { display: "flex", alignItems: "center", gap: 2 }, children: [
      /* @__PURE__ */ C(
        st,
        {
          variant: "outlined",
...
const ts = ({ field: e, formik: t }) => {
  const [r, a] = Ge.useState({}), o = dn(r, 300);
  Ge.useEffect(() => {
    if (t.values[e])
      try {
  ...
  const [u, p] = Ge.useState(/* @__PURE__ */ new Set()), { activeStep: l, setActiveStep: h } = Ge.useContext(fn), c = {};
  for (let O = 0, N = t.columns.length; O < N; O++) {
    const { field: K, skip: q } = t.columns[O];
    q && (c[q.step] = r.values[K]);
  }
  const f = (O) => u.has(O) || c[O], b = () => {
    for (let O = l + 1; O < e.length; O++)
      if (!f(O))
        return !1;
    return !0;
  }, E = () => {
    ...
    for (; c[O]; )
      O++;
    p((N) => new Set(N).add(l)), O >= e.length || b() ? g() : h(O);
  }, x = () => {
    let O = l - 1;
    for (; c[O] && O > 0; )
      O--;
  ...
  const T = e[l];
  return /* @__PURE__ */ C(ue, { children: [
    /* @__PURE__ */ n(go, { activeStep: l, sx: { marginBottom: "20px" }, children: e.map(({ title: O, key: N }, K) => /* @__PURE__ */ n(yo, { completed: f(K), children: /* @__PURE__ */ n(bo, { children: /* @__PURE__ */ n(Fe, { sx: { fontSize: "20px" }, children: O }) }) }, N)) }),
    /* @__PURE__ */ C(Ge.Fragment, { children: [
  ...
  const u = ct.emptyIdValues.includes(i), { formElements: p, tabColumns: l } = Ge.useMemo(() => {
...
const cs = Vr(({ relation: e, parentFilters: t, parent: r, where: a, models: o, readOnly: s }) => {
  ...
  const p = e.formTitle || e.title, { navigate: l, getParams: h, useParams: c, pathname: f } = Kt(), { relations: b = [] } = e, { dispatchData: E, stateData: x } = He(), T = c() || h, { id: O = "" } = T, N = O.split("-")[0], K = new URLSearchParams(window.location.search), q = K.has(De.baseData) && K.get(De.baseData);
  if (q) {
    const B = JSON.parse(q);
    typeof B === De.object && B !== null && (i = { ...i, ...B });
  }
  const [ae, ee] = A(!0), [F, X] = A({}), [te, M] = A(null), [H, U] = A(!1), P = Ht(), [W, Y] = A(null), [J, ye] = A(0), [Z, be] = A(!1), [Te, rt] = A(null), [Re, Ne] = A(""), Be = x?.gridSettings?.permissions?.Url || "", Le = typeof e.applyFieldConfig === De.function ? e.applyFieldConfig({ data: F, lookups: te }) : us, we = ge(() => `${Be}${e.api || t || ""}`, [Be, e.api, t]), { mode: ut } = x.dataForm, xt = x.getUserData || {}, pt = {
    add: !0,
    edit: !0,
    delete: !0,
    ...e.permissions,
  ...
  }), { hideBreadcrumb: pe = !1, navigateBack: S } = e, k = () => {
    let B;
    switch (typeof S) {
      case De.function:
        B = S({ params: T, searchParams: K, data: F });
        break;
      case De.number:
      case De.string:
        B = S;
  ...
  oe(() => {
    if (!Be) return;
    Y(e.getValidationSchema({ id: N, snackbar: P }));
    const B = O.split("-");
    nn({
      ...{
        api: t || we,
  ...
  const ce = Jr({
    ...
    ce.resetForm(), be(!1), S !== !1 && k();
  }, qe = function(B, Ee) {
    P.showError(B, Ee), k();
  }, he = function({ id: B, title: Ee, record: Q, lookups: Je }) {
    const Ze = O.indexOf("-") > -1, Xe = !B || B === "0", qt = Xe ? De.create : Ze ? De.copy : De.edit, ft = Xe ? "" : Q[e.linkColumn], $e = [{ text: e.breadCrumbs }, { text: qt }];
    Ze && (Q[e.linkColumn] = ""), e.columns.forEach((It) => {
      It.skipCopy && Ze && (Q[It.field] = "");
    }), X(Q), M(Je), ft !== "" && $e.push({ text: ft }), E({
      type: V.PAGE_TITLE_DETAILS,
      payload: {
        showBreadcrumbs: !0,
        breadcrumbs: $e
    ...
    Ke && _e ? be(!0) : S !== !1 && k(), B.preventDefault();
  }, Me = async function() {
    try {
      U(!0), await an({
        id: N,
        ...
        setError: P.showError,
        setErrorMessage: Ne
      }) === !0 && (P.showMessage("Record Deleted Successfully."), S !== !1 && k());
    } catch {
      P.showError("An error occured, please try after some time.");
    } finally {
      U(!1);
    }
  }, fe = () => {
  ...
  const Ae = function(B) {
    ...
    { text: p },
    { text: N === "0" ? "New" : "Update" }
  ], at = Number(N) !== 0 && !!b.length, Pt = K.has("showRelation"), _e = !("canEdit" in F) || F.canEdit, me = !_e || F.readOnlyRelations;
